...
<%
     ...
     +"<table><tr><th>Candiadte Id:</th><td><input type='text' id='cid' value='"+ candidate.getCandidateId()+"'></td></tr>"
     +"<tr><th>Candiadte Name:</th><td><input type='text' id='cname' value='"+ candidate.getCandidateName()+"'></td></tr>"
   ...
   +"<tr><th><input type='button'  value='Delete candidate' onclick='deletecandidate()' id='deletecnd' ></th></tr></table></form>");
       out.println(displayBlock);
     }
