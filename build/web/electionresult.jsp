...
<%
    ...
    while(i.hasNext())
    {
        ...
        displayBlock.append("<tr id='"+("tr"+count)+"' style='outline: thin solid'><td>"+e.getKey().getCandidateId()+"</td><td>"+e.getKey().getCandidateName()+"</td><td>"+e.getKey().getParty()+"</td><td><img src='data:image/jpg;base64,"+e.getKey().getSymbol()+"' style='width:300px;height:200px;'/></td><td>"+e.getValue()+"</td><td>"+ ( (int)(e.getValue()*100.0)/votecount) + "%</td></tr>");
        count++;
    }
