...
<html>
    ...
    <body>
        <%
            ...
            displayBlock.append("<br/><br/><div class='candidateprofile'></div>");
            displayBlock.append("<br/><br/><div class='candidateprofile'>you have voted for</div>");
            ...
            displayBlock.append("<div align='center' id='logout' style='color:white; font-size:15px;'><h2 ><a href='voteractions.jsp' style='color:white' >Manage Profile</a></h2><div>");
